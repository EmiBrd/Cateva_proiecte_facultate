...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Wallace_Tree_16/Wallace_Tree_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace16_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wallace16_tb.tcl -notrace
