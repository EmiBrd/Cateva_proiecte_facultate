...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Wallace_Tree_16/Wallace_Tree_16.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Inmultire_wallace_16_mainn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Inmultire_wallace_16_mainn.tcl -notrace
