...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Wallace_Tree_16/Wallace_Tree_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace16_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallace16_tb.tcl
