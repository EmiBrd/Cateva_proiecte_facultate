...
entity multiplier_CPA_16_tb is
--  Port ( );
end multiplier_CPA_16_tb;


architecture Behavioral of multiplier_CPA_16_tb is
...
begin
   ...
   DUT1: multiplier_CPA_16 port map( A => X, B => Y, prod => P );
