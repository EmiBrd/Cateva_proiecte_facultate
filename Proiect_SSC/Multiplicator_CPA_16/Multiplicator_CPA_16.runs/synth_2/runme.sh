...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Multiplicator_CPA_16/Multiplicator_CPA_16.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Inmultire_mainn_CPA_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inmultire_mainn_CPA_16.tcl
