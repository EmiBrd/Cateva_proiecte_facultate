...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Multiplicator_CPA_16/Multiplicator_CPA_16.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Inmultire_mainn_CPA_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Inmultire_mainn_CPA_16.tcl -notrace
