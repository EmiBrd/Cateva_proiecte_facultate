...
HD_PWD='C:/D/An3/An3_sem1_exerc/SSC/SSC_proiect/Multiplicator_CPA_16/Multiplicator_CPA_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_CPA_16_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_CPA_16_tb.tcl -notrace
